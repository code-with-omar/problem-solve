...
function checkIfInstanceOf(value, classOrSuperclass) {
    ...
    return checkIfInstanceOf(Object.getPrototypeOf(value), classOrSuperclass);
}

// Test examples
const example1 = () => checkIfInstanceOf(new Date(), Date);
...
const example3 = () => checkIfInstanceOf(Date, Date);
console.log(example3()); // Output: false

const example4 = () => checkIfInstanceOf(5, Number);
